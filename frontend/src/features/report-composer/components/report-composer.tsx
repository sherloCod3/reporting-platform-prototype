...
/**
 * ReportComposer — Main composition layout (feature entry component).
 *
 * Layout: sidebar (section panel) + center canvas (edit sections / preview).
 * This is the primary entry point for the report-composer feature.
 *
 * Design direction: "Calm Instrument — Industrial Utilitarian"
 * Consistent with the existing ReportEditor aesthetic: slate scale,
 * technical blue accents, backdrop blur surfaces, minimal chrome.
 */
...
interface ReportComposerProps {
  /** Optional report name for the toolbar title */
  reportName?: string;
}

// ---------------------------------------------------------------------------
// Section Edit Renderer (Private)
// ---------------------------------------------------------------------------
...
/** Dispatches to the correct editable section component based on type */
...
export const ReportComposer: React.FC<Readonly<ReportComposerProps>> = ({
  ...
  /** Handles section insertion from toolbar */
  ...
  /** Handles section selection from either panel or canvas */
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-6rem)] w-full bg-app text-foreground border border-border rounded-lg overflow-hidden relative shadow-sm">
      ...
      {/* Workspace: Sidebar + Center Canvas */}
      <div className="flex-1 flex min-h-0">
        ...
        {state.viewMode === "preview" ? (
          ...
          /* Edit Mode — Vertical section stack */
          <div
