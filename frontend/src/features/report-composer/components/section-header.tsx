...
/**
 * SectionHeader — Editable header section for report composition.
 *
 * Renders an inline-editable header with title, subtitle, logo toggle,
 * and date toggle. The visual output mirrors the future PDF header.
 */
...
export const SectionHeader: React.FC<Readonly<SectionHeaderProps>> = memo(
  function SectionHeader({ section, isSelected, onUpdate, onSelect }) {
    ...
    /** Handles subtitle field changes */
    ...
    return (
      <div
        ...
        role="button"
        tabIndex={0}>
        {/* Header Preview — How it will look in the PDF */}
        <div className="px-6 pt-6 pb-4">
          {/* Logo placeholder + date row */}
