      ...
      <div className="p-4 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-[10px] mb-1 block">X Position</Label>
              <Input
                type="number"
            ...
            <div>
              <Label className="text-[10px] mb-1 block">Y Position</Label>
              <Input
                type="number"
            ...
            <div>
              <Label className="text-[10px] mb-1 block">Width</Label>
              <Input
                type="number"
            ...
            <div>
              <Label className="text-[10px] mb-1 block">Height</Label>
              <Input
                type="number"
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-[10px] mb-1 block">Background</Label>
            ...
            <div>
              <Label className="text-[10px] mb-1 block">Border Color</Label>
              <div className="flex gap-1">
                <Input
                  type="color"
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-[10px] mb-1 block">Border Width</Label>
              <Input
                type="number"
            ...
            <div>
              <Label className="text-[10px] mb-1 block">Radius</Label>
              <Input
                type="number"
          ...
          <>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <Label className="text-[10px] mb-1 block">Size (px)</Label>
                  <Input
                    type="number"
              ...
              <div>
                <Label className="text-[10px] mb-1 block">Alignment</Label>
